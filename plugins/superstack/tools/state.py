...
def _run_gauntlet() -> dict:
    ...
    # Планка живёт в КОРНЕ репозитория (`tools/gauntlet.py`) и не входит в
    # пакет — значит на машине человека её нет и не будет. Прежний путь
    ...
    #
    # Ищем вверх по дереву от себя; не нашли — говорим прямо.
